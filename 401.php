...
<div class="center-box">
  ...
  <h1>401</h1>
  <p><b>Yetkisiz erişim</b></p>
  <p>Bu sayfaya erişmek için giriş yapman gerekiyor.</p>

  <button class="btn" onclick="location.href='login.php'">Giriş Yap</button>
</div>
